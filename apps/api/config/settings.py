"""
Django settings for noyan project.
"""
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # Custom validators for strong password policy
    {
    ...
    {
        'NAME': 'apps.users.validators.WeakPasswordValidator',
    },
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Noyan E-Commerce API',
    'DESCRIPTION': 'API for Noyan premium e-commerce platform',
    'VERSION': '1.0.0',
